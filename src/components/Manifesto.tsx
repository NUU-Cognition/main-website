      ...
      <div className="max-w-2xl w-full">
        ...
        <div className="space-y-12">
          <div>
            ...
            Human progress is a story about technology. The tools we've built to solve problems and overcome limitations. For centuries, these tools have focused on helping us master the physical world. Now, it's time to for our tools to master the mind. 
            <br />
            <br />
